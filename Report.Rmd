...
```{r attrition-univariate, echo = FALSE, fig.cap = 'Bar plot of Attrition Status illustrating a significant class imbalance with high employee retention (83.9%).', fig.height = 2.5, fig.width = 3}
...
knitr::kable(
  inc_stats,
  caption = "Descriptive Statistics: Monthly Income"
)
```
