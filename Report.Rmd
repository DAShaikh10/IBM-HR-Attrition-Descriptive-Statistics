...
**Interpretation:** The data reveals a **strong skew** toward positive work-life balance, with **"Better"** _(60.75%, n=893)_ as the dominant **modal** category. Cumulatively, **71.16%** of the workforce falls into the **top two tiers** _("Better" or "Best")_, while only **5.44%** report a _"Bad"_ balance.
...
# Simple base R scatter plot with regression line using smoothScatter [@R-graphics].
smoothScatter(
  hr$YearsAtCompany,
  hr$MonthlyIncome,
