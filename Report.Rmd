...
legend(
  ...
  lwd = 2,
  lty = c(2, 1),
  # Match line types (2=Dashed, 1=Solid)
  bty = "n",
  cex = 0.9
)
...
knitr::kable(
  cor_table,
  align = c('l', 'c'),
  caption = "Correlation Coefficients: Monthly Income vs Attrition",
  digits = 2
)  
```
...
knitr::kable(reg_table,
             caption = "Regression Coefficients: Monthly Income ~ Years at Company",
             align = 'c',
             row.names = FALSE)
...
knitr::kable(
  metrics_table_horiz,
  caption = "Model Fit Statistics (Horizontal)",
  align = 'c',
  row.names = FALSE
)
```
